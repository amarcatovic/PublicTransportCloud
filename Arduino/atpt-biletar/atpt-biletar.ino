...
void sendRfidLog(long cardId) {
  ...
  if(WiFi.status() == WL_CONNECTED) {
    ...
    String postData = "cardid=" + String(cardId) + "&action=karticaRegistrovana";
    
    Serial.println("KarticaID:");
    Serial.println(String(cardId));
    
    //http.begin("http://192.168.0.14/rfid/log.php");   
    http.begin("http://192.168.43.141/rfid/log.php");   
  ...
  {
    //OVDJE CE SE SPREMATI NA SD KARTICU JER NEMA KONEKCIJE
  }
}
