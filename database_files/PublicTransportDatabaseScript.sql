...
CREATE TABLE KorisnikUloga(
	korisnik_id INT,
    uloga_id INT,
    CONSTRAINT PK_KorisnikUloga PRIMARY KEY (korisnik_id, uloga_id),
    CONSTRAINT FK_KorisnikUloga_korisnik FOREIGN KEY (korisnik_id) REFERENCES KorisnikAplikacije(id_korisnik),
    CONSTRAINT FK_KorisnikUloga_uloga FOREIGN KEY (uloga_id) REFERENCES Uloga(id_uloga)
);
